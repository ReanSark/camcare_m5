'use client'; // ✅ Needed for useEffect and useState in client component

import { useEffect, useState } from 'react';
import Link from 'next/link';
import { toast } from 'sonner'; // ✅ Toast feedback on failure
...
export default function PatientsPage() {
  ...
  useEffect(() => {
    const fetchPatients = async () => {
      try {
        ...
        // ✅ Manual mapping to enforce field safety & override Appwrite's DefaultDocument
        ...
        toast.error('Failed to load patients'); // ✅ Error toast
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="p-6">
      ...
      {/* ✅ Conditional loading and fallback UI */}
      {loading ? (
        <p>Loading...</p>
      ) : patients.length === 0 ? (
